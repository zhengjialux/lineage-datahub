...
import type { NodeData, EntitySelectParams, TreeProps, VizNode, VizEdge, EntityAndType, UpdatedLineages } from './types';
    ...
    return (
        <Group transform={transformToString(zoom.transformMatrix)} top={margin?.top} left={margin?.left}>
            {[
                ...
                return <LineageEntityEdge edge={link} edgeKey={key} key={key} isHighlighted={!!isHighlighted} />;
            })}
