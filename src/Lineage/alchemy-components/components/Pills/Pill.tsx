...
import { ColorValues, PillVariantValues, SizeValues } from '../../theme/config';
import type { ColorOptions, PillVariantOptions } from '../../theme/config';
import React from 'react';
import { PillContainer, PillText } from './components';
import type { PillProps, PillPropsDefaults } from './types';
