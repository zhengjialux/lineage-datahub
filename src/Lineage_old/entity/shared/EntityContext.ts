...
import { shouldEntityBeTreatedAsPrimary } from './siblingUtils';
import type { EntityContextType, UpdateEntityType } from './types';
...
export const useMutationUrn = () => {
    ...
    const { isHideSiblingMode } = useContext(LineageExplorerContext);
