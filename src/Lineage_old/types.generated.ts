 ...
 */
export type DataFlow = BrowsableEntity & Entity & EntityWithRelationships & {
  __typename?: 'DataFlow';
  /**
   * Experimental API.
   * For fetching extra entities that do not have custom UI code yet
 ...
 */
export type DataJob = BrowsableEntity & Entity & EntityWithRelationships & {
  __typename?: 'DataJob';
  /**
   * Experimental API.
   * For fetching extra entities that do not have custom UI code yet
...
export type Dataset = BrowsableEntity & Entity & EntityWithRelationships & SupportsVersions & {
  __typename?: 'Dataset';
 ...
 * schema field
 */
export type SchemaFieldEntity = Entity & EntityWithRelationships & {
